...
This is codebase from [openai/CLIP](https://github.com/openai/CLIP), [luciderains/denoising-diffusion-pytorch](https://github.com/lucidrains/denoising-diffusion-pytorch). <br/> 
